...
const CONTEXT_IMPORTS = [
  ...
  { file: 'context/decisions.md', from: 'arman-status-13-sept.md', why: 'the open list, reconciled into tracker.json; log it under a heading ending "arman-status-13-sept imported"', marker: /^##\s.*arman-status-13-sept imported\s*$/m },
];
